...
function ContentDisplay() {
    return <>
        <div className="grid grid-rows-2">
            <div className="flex h-screen flex-col justify-center" id="intro">
                <Introduction />
            </div>
            ...
            <div className="flex h-screen flex-col justify-center" id="skill">
                <SkillSet />
                <br />
                <Language />
            </div>
...
function Introduction() {
    return <div className='text-7xl text-left'>
        <p>Hello World!</p>
        <p>I am Jack Lam</p>
...
function Educations() {
    return <div>
        <p className='text-5xl text-left'>Education History</p>
        <div className='text-2xl text-left my-2.5'>
...
function WorkExperience() {
    return <div>
        <p className='text-5xl text-left'>Work Experience</p>
        <div className='text-2xl text-left my-2.5'>
...
function SkillSet() {
    return <div>
        <p className='text-5xl text-left'>Skill Set</p>
        <div className='text-2xl text-left my-2.5'>
...
function Language() {
    return <div>
        <p className='text-5xl text-left'>Language</p>
        <div className='text-2xl text-left my-2.5'>
